...
import '../04currentFestivalsSlider/FestivalsSlider.css';
import {NextFest} from './DataNextFest';
import FestItem from "../04currentFestivalsSlider/FestItem";

class NextFestivalsSlider extends Component{
    constructor(props) {
        super(props);
        this.state = {
            position: 0,
    ...
    render() {
        return(
            <div className="wrapper">
                <div className='currentText'><p>Ближайшие фестивали</p></div>
...
export default NextFestivalsSlider;